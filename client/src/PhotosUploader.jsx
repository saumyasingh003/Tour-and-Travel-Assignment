            ...
            <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
                ...
                {addedPhotos.length > 0 && addedPhotos.map(link=>(
                  <div className="h-32 flex relative" key={link}> {/*key={link}*/}
                    {/* {link} */}
                    <img className="rounded-2xl w-full object-cover" src={'https://travel-agency-assignment.onrender.com/uploads/'+link} alt=""/>  {/* <Image className="rounded-2xl w-full object-cover" src={link} alt=""/>*/}
